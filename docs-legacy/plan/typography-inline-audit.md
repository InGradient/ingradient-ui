...
> **Status — archived historical audit ledger.** 아래 사례와 수치는 audit 당시 기록이다. 현재 design/token authority는 [`DESIGN.md`](../../DESIGN.md)와 checked-in token source다.
...
| Control sizes 7-tier 확장 (xs/xl/2xl/3xl 추가) + styled 토큰화 | 15건 + 토큰 신규 4 | **0** |
