...
> **Status — archived historical plan.** 이 문서는 2026-05 판단 과정을 보존한다. 이후 domain extraction 결과와 현재 위치는 [Components Vs Patterns](../../docs/reference/components-vs-patterns.md)와 [`@ingradient/platform-pages`](../../packages/platform-pages/README.md)를 우선한다.

작성일: 2026-05-25
브랜치: `refactor/components-vs-patterns-audit`
선행 작업: `docs-legacy/reports/components-extraction-candidates-2026-05.md` (Phase 0~4 완료, 인라인 styled 499 → 57 / 89% 제거)
