...
> **Status — archived historical execution record.** 아래 수치와 위치는 2026-05 audit 당시 상태다. 현재 layer/package authority는 [Components Vs Patterns](../../docs/reference/components-vs-patterns.md)와 [`@ingradient/platform-pages`](../../packages/platform-pages/README.md)를 따른다.
...
1. 이 archived 문서 (`docs-legacy/reports/components-extraction-candidates-2026-05.md`)의 "진행 현황" 섹션 읽기
