...
> **Status — archived dated audit snapshot.** 아래 line coverage와 판정은 2026-06-25 기준이다. 현재 계층과 package ownership은 [`ui-refactoring-rule.md`](../ui-refactoring-rule.md), [Components Vs Patterns](../docs/reference/components-vs-patterns.md), [`@ingradient/platform-pages`](../packages/platform-pages/README.md)를 따른다.
