...
> **Status — archived dated re-audit snapshot.** 아래 수치와 완료 판정은 2026-06-28~29 기준이다. 현재 계약은 [`ui-refactoring-rule.md`](../ui-refactoring-rule.md), [`DESIGN.md`](../DESIGN.md), [Platform Story Contract](../stories/pages/platform/0.0.1/README.md)를 따른다.
