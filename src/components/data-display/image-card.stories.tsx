...
export const Grid3x3: Story = {
  render: () => (
    <Grid columns="repeat(3, 1fr)" gap={3} style={{ width: 720 }}>
      <ImageCard image={{ id: '1', name: 'A.jpg', thumb_url: sample1 as string, sync_state: 'synced' }} />
      <ImageCard image={{ id: '2', name: 'B.jpg', thumb_url: sample2 as string, sync_state: 'uploading' }} selected />
      <ImageCard image={{ id: '3', name: 'C.jpg', thumb_url: sample3 as string, sync_state: 'upload_failed' }} />
      ...
      <ImageCard image={{ id: '6', name: 'F.jpg', thumb_url: sample3 as string, group_count: 12, sync_state: 'synced' }} />
    </Grid>
  ),
}
