 ...
 * |---|---|---|---|
 * | H1 | 5xl (32px) | 800 | Page hero title |
 * | H2 | 4xl (28px) | 700 | Section title |
 * | H3 | 2xl (20px) | 600 | Subsection title |
 * | H4 | xl  (18px) | 600 | Block title, dialog title |
 * | B1 | lg  (16px) | 400 | Body large — emphasis body |
