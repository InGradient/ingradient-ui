...
function buildColorVars(theme: IngradientTheme, palette: Palette, shadows: Shadows, isLight: boolean) {
  return {
    ...
    '--ig-color-shadow-soft': palette.shadowSoft,
    '--ig-color-shadow-medium': palette.shadowMedium,
    '--ig-color-shadow-strong': palette.shadowStrong,
...
const staticVars = {
  ...
  '--ig-opacity-svg-fill-faint': String(opacityScale.svgFillFaint),
  ...
  '--ig-opacity-loud-plus': String(opacityScale.loudPlus),
  ...
  '--ig-popup-xs-tight': popupSizes.xsTight,
  ...
  '--ig-popup-xs-plus': popupSizes.xsPlus,
  '--ig-popup-xs-narrow': popupSizes.xsNarrow,
  '--ig-popup-sm-narrow': popupSizes.smNarrow,
  '--ig-popup-2xs-narrow': popupSizes['2xsNarrow'],
  '--ig-popup-3xs-plus': popupSizes['3xsPlus'],
  '--ig-popup-3xs-wide': popupSizes['3xsWide'],
  '--ig-popup-2xs-narrow-tight': popupSizes['2xsNarrowTight'],
  '--ig-popup-2xs-tight': popupSizes['2xsTight'],
  '--ig-popup-lg-plus': popupSizes.lgPlus,
  '--ig-popup-filter-panel': popupSizes.filterPanel,
  ...
  '--ig-layout-sidebar-collapse': layoutScale.sidebarCollapse,
  '--ig-layout-panel-min-height': layoutScale.panelMinHeight,
  '--ig-layout-loading-panel-height': layoutScale.loadingPanelHeight,
  '--ig-form-label-col': layoutScale.formLabelCol,
  '--ig-form-label-col-wide': layoutScale.formLabelColWide,
