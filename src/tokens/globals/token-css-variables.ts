...
function buildColorVars(theme: IngradientTheme, palette: Palette, shadows: Shadows, isLight: boolean) {
  ...
  return {
    ...
    '--ig-color-blue-tint-30': isLight ? 'rgba(58, 115, 230, 0.3)' : 'rgba(77, 136, 255, 0.3)',
    ...
    '--ig-color-green-tint-06': isLight ? 'rgba(22, 163, 74, 0.08)' : 'rgba(43, 181, 114, 0.06)',
    ...
    '--ig-color-slate-tint-92': isLight ? 'rgba(229, 231, 235, 0.92)' : 'rgba(75, 85, 99, 0.92)',
