...
- `core/` (19 카테고리)
  - raw 절대값:
    ...
    - **Layout**: `layout.ts` (pageMaxWidth/topbar/captureBar/sidebarBrand/logDetail-*/datasetCard-*/histogram-*/statsMin/gridLabelCol)
    - **Control sizes**: `control-sizes.ts` (xs/xsPlus/sm/smPlus/md/midPlus/midPlusTall/lg/xl/2xl/2xlWide/3xl/capture, 13 tier)
